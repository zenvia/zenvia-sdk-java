...
public class ClientApacheAutoConfigurationTest {

	private ApplicationContextRunner contextRunner = new ApplicationContextRunner()
			.withConfiguration(AutoConfigurations.of(ClientApacheAutoConfiguration.class));
	...
	void testWhenThereIsNoApiTokenOnPropertiesTheClientShouldNotBeCreated() {
		this.contextRunner.run((context) -> {
			assertThat(catchThrowable(() -> { context.getBean(Client.class); }))
				...
				.hasMessageContaining("No qualifying bean of type 'com.zenvia.api.sdk.client.apache.Client' available");
		});
	}
